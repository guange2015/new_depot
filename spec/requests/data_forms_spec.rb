...
describe "DataForms" do
  ...
  describe "GET /data_forms" do
    ...
    it {page.should have_selector('h1', :text => "入出库单")}
  end
  ...
  describe "入出库单" do
    ...
    it {
      click_link '新入库单'  
      page.should have_selector('h1', :text => "入库单")
    }
    it {
      click_link '新出库单'  
      page.should have_selector('h1', :text => "出库单")
    }
  end
  ...
  describe "新入库单" do
    ...
    it {
      ...
      click_button '提交'
      page.current_path.should =~ /\/data_forms\/\d/
    }    
    it {
      click_button '提交'
